...
(function ($, undefined) {
    ...
    var onLoadError = function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        var msg;
        if (XMLHttpRequest && !$.string.isNullOrWhiteSpace(XMLHttpRequest.responseText)) {
        ...
        var win = $.easyui.messager.alert("错误提醒", msg, "error"), opts = win.window("options"),
            panel = win.window("panel"), width = panel.outerWidth(), height = panel.outerHeight();
